...
public class TETile implements Serializable {
     ...
     * @param filepath        Full path to image to be used
     *                        for this tile. Must be correct size (16x16)
     */
     ...
     */
    public TETile(Color backgroundColor, TETile t) {
    ...
    public boolean equals(TETile t2) {
        return this.character() == t2.character();
    }
